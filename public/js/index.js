...
function generarPrediccion(e) {
  ...
  if (
    ...
    saveData(
      _poblacionInicial.value,
      _anios.value,
      {
        "Tasa Natalidad": _tasaNatalidad.value,
        "Tasa Mortalidad": _tasaMortalidad.value,
        "Tasa Inmigración": _tasaInmigracion.value,
        "Tasa Migración ": _tasaMigracion.value,
      },
      prediccion
    );
